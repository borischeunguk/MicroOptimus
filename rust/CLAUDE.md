...
sor focus on order routing logic,which takes child orders from algo module and routes to two venues ( CME, NASQ ) based on market conditions and order parameters. 
